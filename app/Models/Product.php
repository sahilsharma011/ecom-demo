...
class Product extends \Eloquent
{
    ...
    {
        $value = new Money((int)$value, new Currency(config('site.money.default_currency', 'INR')));
    ...
    {
        return new Money((int)$value, new Currency(config('site.money.default_currency', 'INR')));
    }
